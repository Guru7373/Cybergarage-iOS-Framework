...
#include "../../../clinkc/AV/Headers/cmediaserver.h"
//#include "../../../include/cybergarage/upnp/std/av/cmediaserver.h"
...
-(NSString *) returnDevHTTPPORT
{
	if (!cAvObject)
		return 0;
    NSString *strFromInt = [NSString stringWithFormat:@"%d",cg_upnpav_dms_port(cAvObject)];
	return strFromInt;
}
