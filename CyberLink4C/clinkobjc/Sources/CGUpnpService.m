...
#include "../../clinkc/Headers/cybergarage/upnp/caction.h"
//#include <cybergarage/upnp/cstatevariable.h>
#include "../../clinkc/Headers/cybergarage/upnp/cstatevariable.h"
...
- (CGUpnpService *)getupnpDevServicebyExactName:(CGUpnpDevice *)cobj name:(NSString *)name;
{
    if (!cobj)
		return nil;
   // NSString *str = @"1234";
	CgUpnpService *cService = cg_upnp_device_getservicebyexacttype(cobj, (char *)[name UTF8String]);
	if (!cService)
		return nil;
	return [[[CGUpnpService alloc] initWithCObject:(void *)cService] autorelease];
