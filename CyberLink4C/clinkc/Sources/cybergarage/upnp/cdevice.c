...
#include "../../../Headers/cybergarage/upnp/cdevice.h"
//#include <cybergarage/upnp/ccontrolpoint.h>
#include "../../../Headers/cybergarage/upnp/ccontrolpoint.h"
//#include <cybergarage/upnp/cupnp_limit.h>
#include "../../../Headers/cybergarage/upnp/cupnp_limit.h"
//#include <cybergarage/util/ctime.h>
#include "../../../Headers/cybergarage/util/ctime.h"
//#include <cybergarage/net/cinterface.h>
#include "../../../Headers/cybergarage/net/cinterface.h"
//#include <cybergarage/net/curl.h>
#include "../../../Headers/cybergarage/net/curl.h"
//#include <cybergarage/upnp/cupnp_function.h>
#include "../../../Headers/cybergarage/upnp/cupnp_function.h"
//#include <cybergarage/upnp/ssdp/cssdp.h>
#include "../../../Headers/cybergarage/upnp/ssdp/cssdp.h"
//#include <cybergarage/upnp/ssdp/cssdp_server.h>
#include "../../../Headers/cybergarage/upnp/ssdp/cssdp_server.h"
//#include <cybergarage/upnp/control/ccontrol.h>
#include "../../../Headers/cybergarage/upnp/control/ccontrol.h"
//#include <cybergarage/io/cfile.h>
#include "../../../Headers/cybergarage/io/cfile.h"
//#include <cybergarage/util/clog.h>
#include "../../../Headers/cybergarage/util/clog.h"
//#include <cybergarage/util/cstring.h>
#include "../../../Headers/cybergarage/util/cstring.h"
...
CgUpnpDevice *cg_upnp_device_new()
{
	...
	if  ( NULL != dev )
	{
        ...
        dev->httpStreamingServerList = cg_http_serverlist_new();
...
void cg_upnp_device_delete(CgUpnpDevice *dev)
{
	...
	cg_http_serverlist_delete(dev->httpStreamingServerList);
...
int getCurrentDeviceHttpPort(CgUpnpDevice *dev)
{
    printf("%d   %d",dev->httpPort,cg_upnp_device_gethttpport(dev));
    return cg_upnp_device_gethttpport(dev);
}
...
BOOL cg_upnp_device_postsearchresponse(CgUpnpDevice *dev, CgUpnpSSDPPacket *ssdpPkt, const char *st, const char *usn)
{
    ...
    // iOS app on iPhone doesnt act as mediaserver so no need to send response to MSearch
//	CgUpnpDevice *rootDev;
...
BOOL cg_upnp_device_start(CgUpnpDevice *dev)
{
    ...
    //Initilaize Mutex
    CgMutex *lib_mutex = cg_mutex_new();
    cg_set_mutex(lib_mutex);
	...
	//httpPort = cg_upnp_device_gethttpport(dev);
	/* Opening HTTP server may fail, so try many ports */
	while(cg_http_serverlist_open(dev->httpStreamingServerList, httpPort) == FALSE)
	{
		cg_upnp_device_sethttpport(dev, httpPort + 1);
		httpPort = cg_upnp_device_gethttpport(dev);
	}
	cg_http_serverlist_setuserdata(dev->httpStreamingServerList, dev);
	cg_http_serverlist_setlistener(dev->httpStreamingServerList, cg_upnp_device_httpStreamingrequestrecieved);
    
	cg_http_serverlist_start(dev->httpStreamingServerList);
