...
#define CG_HTTP_ACCEPT_RANGES "Accept-Ranges"
#define CG_HTTP_TRANSFERMODEDLNAORG "TransferMode.DLNA.ORG"
#define CG_HTTP_CONTENTRANGE "Content-Range"
...
#define cg_http_packet_setcontent(httpPkt, value) cg_string_setvalue(httpPkt->content, value)
    #define cg_http_packet_setcontent1(httpPkt, value) cg_hexdump_setvalue(httpPkt->content, value)
...
BOOL cg_http_request_postresponse(CgHttpRequest *httpReq, CgHttpResponse *httpRes);
    BOOL cg_http_request_postresponse_user(CgHttpRequest *httpReq, CgHttpResponse *httpRes);
...
#define cg_http_response_setcontent(httpRes,value) cg_http_packet_setcontent(((CgHttpPacket*)httpRes),value)
    #define cg_http_response_setcontent1(httpRes1,value) cg_http_packet_setcontent1(((CgHttpPacket1*)httpRes1),value)
...
#define cg_http_response_setacceptranges(httpRes,value) cg_http_packet_setheadervalue((CgHttpPacket*)httpRes,CG_HTTP_ACCEPT_RANGES,value)
#define cg_http_response_setcontentrange(httpRes,value) cg_http_packet_setheadervalue((CgHttpPacket*)httpRes,CG_HTTP_CONTENTRANGE,value)
#define cg_http_response_settransfermode(httpRes,value) cg_http_packet_setheadervalue((CgHttpPacket*)httpRes,CG_HTTP_TRANSFERMODEDLNAORG,value)
...
/** Clear persistent connection cache and SAFE_FREE all memory */
